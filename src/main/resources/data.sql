...
INSERT INTO `trn_profile_sequence` VALUES (10001);
...
INSERT INTO `trn_dependent_sequence` VALUES (10003);

INSERT INTO `trn_mass_time_sequence` VALUES (1000);

INSERT INTO `mst_community_allocation` (`id`,`create_time`,`created_by_user`,`is_deleted`,`update_time`,`updated_by_user`,`version_number`,`description`,`code`,`total_allocation`)
VALUES (1,'2021-07-14 09:45:06.863000','Admin','\0',NULL,'Admin',0,'BEC','BEC',49),
(2,'2021-07-14 09:45:06.863000','Admin','\0',NULL,'Admin',0,'Parish Group','PG',49),
(3,'2021-07-14 09:45:06.863000','Admin','\0',NULL,'Admin',0,'Parishioners','PS',101),
(4,'2021-07-14 09:45:06.863000','Admin','\0',NULL,'Admin',0,'Core Team','CT',40);
...
INSERT INTO `mst_seating_category` (`id`,`create_time`,`created_by_user`,`is_deleted`,`update_time`,`updated_by_user`,`version_number`,`description`,`tag`,`total_capacity`)
VALUES (1,'2021-07-14 09:45:06.863000','Admin','\0',NULL,'Admin',0,'Caretaker','CARE',2),
(2,'2021-07-14 09:45:06.863000','Admin','\0',NULL,'Admin',0,'Hospitality Minister','HM',12),
(3,'2021-07-14 09:45:06.863000','Admin','\0',NULL,'Admin',0,'Elderly','SNR',10),
(4,'2021-07-14 09:45:06.863000','Admin','\0',NULL,'Admin',0,'Registration Team','RT',5),
(5,'2021-07-14 09:45:06.863000','Admin','\0',NULL,'Admin',0,'Lector','LEC',1),
(6,'2021-07-14 09:45:06.863000','Admin','\0',NULL,'Admin',0,'EMOHC','EMOHC',5),
(7,'2021-07-14 09:45:06.863000','Admin','\0',NULL,'Admin',0,'Priest & Alterboys','SAN',7),
(8,'2021-07-14 09:45:06.863000','Admin','\0',NULL,'Admin',0,'Choir & Organist','MM',6),
(9,'2021-07-14 09:45:06.863000','Admin','\0',NULL,'Admin',0,'Audio Video','AV',3),
(10,'2021-07-14 09:45:06.863000','Admin','\0',NULL,'Admin',0,'MC','MC',1),
(11,'2021-07-14 09:45:06.863000','Admin','\0',NULL,'Admin',0,'PUBLIC','PUBLIC',185),
(12,'2021-07-14 09:45:06.863000','Admin','\0',NULL,'Admin',0,'WCB','WCB',2);
