...
@And({ @Spec(path = "massTimeId", params = "massTimeId", spec = Equal.class),
		@Spec(path = "massBookingNo", params = "massBookingNo", spec = Like.class),
...
public interface MassBookingSerachSpec extends Specification<MassBooking> {
